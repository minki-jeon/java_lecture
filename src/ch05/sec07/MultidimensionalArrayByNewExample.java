...
public class MultidimensionalArrayByNewExample {
    //* Reference : [Book. 이것이 자바다] p.184
    public static void main(String[] args) {
        // 각 반의 학생 수가 3명으로 동일할 경우 점수 저장을 위한 2차원 배열 생성
        int[][] mathScores = new int[2][3];
        // qoduf gkdahr chrlrkqt cnffur
        ...
        System.out.println("전체 학생의 수학 합산 점수: " + totalMathSum);
        ...
        System.out.println("전체 학생의 영어 점수 합 = " + totalEnglishSum);
