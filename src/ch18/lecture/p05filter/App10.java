...
public class App10 {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        // 직렬화 가능한 객체만 ObjectInputStream, ObjectOutputStream으로 역직렬화, 직렬화 가능
        Book10 book = new Book10("java", 3000);

        String file = "D:\\01.private_work\\Choongang\\workspaces\\Temp\\filter10.txt";
        // 객체를 직렬화로 파일에 쓰기
...
// Serializable 인터페이스를 구현한 클래스의 객체만 직렬화
